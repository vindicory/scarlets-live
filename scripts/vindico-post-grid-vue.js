  ...
  template: `
      <div class="gridpostitem" :style="backgroundImage">
        ...
        <div class="articledate">
          <div class="articlemonth">{{ formatDate(post.date, 'YYYY-MM-DDTHH:mm:ss', 'MMM') }}</div>
          <div class="articleday">{{ formatDate(post.date, 'YYYY-MM-DDTHH:mm:ss', 'DD') }}</div>
          <div class="articleyear">{{ formatDate(post.date, 'YYYY-MM-DDTHH:mm:ss', 'YYYY') }}</div>  
        </div>
        <div class="articletitle"><div class="titlepadding">{{ post.title.rendered }}</div></div>
      </div>     
  `
})
